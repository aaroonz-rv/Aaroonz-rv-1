function initengahan() {
  rayaIn.style = "display:none"; ket.style = "display:none";
...
function aktipesan8() {
  ...
  ftganti = 4; ftmuncul();
  new TypeIt("#pesan8", {
    strings: ["" + vketik8, "" + vketik9], startDelay: 20, speed: 65, cursor: true, deleteSpeed: 150, breakLines: false, waitUntilVisible: true, lifelike: true,
    afterComplete: function () {
